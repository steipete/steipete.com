...
description: "`keyboardShortcut` is a convenient way to add shortcuts in SwiftUI. However, it likely won't work. I've been curious why that is, so let's follow me for a round of SwiftUI debugging! Spoiler: the workaround is at the end of this article."
---
