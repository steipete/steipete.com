...
Checkra1n is semi-tethered while Unc0ver is semi-untethered. (See [types of jailbreaks](https://www.idownloadblog.com/2019/11/21/types-of-jailbreaks/)). You need to re-trigger the jailbreak after a reboot to patch the kernel, so it can run unsigned code. I recommend using [AltStore](https://altstore.io/) to install the Jailbreak. ([guide](https://www.idownloadblog.com/2020/02/16/how-to-unc0ver-altstore/))
